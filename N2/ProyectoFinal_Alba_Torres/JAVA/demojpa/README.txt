...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/edu/ups/pweb/demojpa/Jsf23Activator.java"
==========================
...
artifact ("demojpa.war") is already built. You can build
